...
The following screenshots show: 1) the state of the board after five turns have been played, and 2) the final state when one of the players has won —in this case the computer player represented by the red pieces.
